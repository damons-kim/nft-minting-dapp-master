      ...
      <s.Screen>
        ...
        >
          ...
          <ResponsiveWrapper flex={1} style={{ padding: 24 }} test>
            <s.SpacerSmall />
            <s.Container flex={1} jc={"center"} ai={"center"}>
              {Number(data.totalSupplyRe) >= CONFIG.eachMaxMintCountForOthers ? (
                <>
                  <s.TextSub
                    style={{
                      textAlign: "center",
                ...
                <>
                  ...
                  >
                    {data.totalSupplyRe} | {CONFIG.eachMaxMintCountForOthers}
                  </s.TextSub>
                  <s.SpacerSmall />
                  {/* <s.TextTotal
                  style={{
                ...
                >
                  Price&emsp;&emsp;&emsp;&emsp;&emsp;{CONFIG.DISPLAY_COST_Others}{" "}
            ...
            {/* <StyledImg className="gif-soon"  src={"/config/images/Re.gif"} alt="image" /> */}
          </ResponsiveWrapper>
        </s.Container>
      </s.Screen>
    </>
